  ...
  return (
    <>
      <button
        ...
        className={`neu-button px-3.5 py-1.5 rounded-full text-xs font-bold transition-all flex items-center gap-1.5 active:scale-95 ${
          justCleared
      ...
      {isOpen && (
        ...
        >
          <div
            className="neu-flat p-6 rounded-3xl max-w-md w-full border border-rose-500/20 shadow-2xl space-y-5"
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="neu-button p-1.5 rounded-full text-slate-400 hover:text-slate-200"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="neu-button px-4 py-2 rounded-full text-xs font-bold text-slate-300 hover:bg-white/5 active:scale-95"
              >
                ยกเลิก
              </button>
              <button
                ...
                className="px-4 py-2 rounded-full text-xs font-bold text-white bg-rose-600 hover:bg-rose-700 active:scale-95 shadow-md flex items-center gap-1.5 transition-all"
              >
